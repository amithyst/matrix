...
if [[ "$SCENE_ID" == "15" \
    ...
    export MATRIX_GAME_PURE_FORWARD_ALIGNMENT_CRAWL="${MATRIX_GAME_PURE_FORWARD_ALIGNMENT_CRAWL:-on}"
    export MATRIX_GAME_GAIT_START_HEADING_ERROR_DEG="${MATRIX_GAME_GAIT_START_HEADING_ERROR_DEG:-15.0}"
    export MATRIX_GAME_GAIT_STOP_HEADING_ERROR_DEG="${MATRIX_GAME_GAIT_STOP_HEADING_ERROR_DEG:-30.0}"
