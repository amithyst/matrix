...
if [[ "$SCENE_ID" == "15" \
    ...
    MATRIX_MOON_BFM_KEYBOARD_SPEED_CAP="${MATRIX_MOON_BFM_KEYBOARD_SPEED_CAP:-0.50}"
    export MATRIX_MOON_BFM_KEYBOARD_SPEED_CAP
    export MATRIX_GAME_KEYBOARD_WALK_SPEED="$MATRIX_MOON_BFM_KEYBOARD_SPEED_CAP"
    export MATRIX_GAME_KEYBOARD_WALK_BOOST_SPEED="$MATRIX_MOON_BFM_KEYBOARD_SPEED_CAP"
    export MATRIX_GAME_KEYBOARD_RUN_SPEED="$MATRIX_MOON_BFM_KEYBOARD_SPEED_CAP"
    export MATRIX_GAME_KEYBOARD_RUN_BOOST_SPEED="$MATRIX_MOON_BFM_KEYBOARD_SPEED_CAP"
    echo "[INFO] moon-v1 BFM controls: keyboard walk/run cap=${MATRIX_MOON_BFM_KEYBOARD_SPEED_CAP}m/s turn=2.40rad/s"
fi
