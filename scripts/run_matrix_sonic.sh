...
GAME_PURE_FORWARD_ALIGNMENT_CRAWL="${MATRIX_GAME_PURE_FORWARD_ALIGNMENT_CRAWL:-on}"
...
if [[ "$SCENE_ID" == "15" \
    ...
    if [[ "$GAME_CAMERA_YAW_SOURCE_ARGUMENT_SET" != "1" ]]; then
        # Preserve the host/profile camera-yaw source for BFM Moon. TRNA sets
        # MATRIX_GAME_CAMERA_YAW_SOURCE=ue-final-pov; overwriting it with
        # fixed breaks camera-relative movement modes after startup.
        GAME_CAMERA_YAW_SOURCE="${MATRIX_MOON_BFM_CAMERA_YAW_SOURCE:-$GAME_CAMERA_YAW_SOURCE}"
    fi
    ...
    export MATRIX_GAME_KEYBOARD_RUN_SPEED="${MATRIX_GAME_KEYBOARD_RUN_SPEED:-$MATRIX_MOON_BFM_SPEED_CAP}"
    export MATRIX_GAME_KEYBOARD_RUN_BOOST_SPEED="${MATRIX_GAME_KEYBOARD_RUN_BOOST_SPEED:-$MATRIX_MOON_BFM_SPEED_CAP}"
    export MATRIX_GAME_PURE_FORWARD_ALIGNMENT_CRAWL="${MATRIX_GAME_PURE_FORWARD_ALIGNMENT_CRAWL:-off}"
    export MATRIX_GAME_GAIT_START_HEADING_ERROR_DEG="${MATRIX_GAME_GAIT_START_HEADING_ERROR_DEG:-6.0}"
    export MATRIX_GAME_GAIT_STOP_HEADING_ERROR_DEG="${MATRIX_GAME_GAIT_STOP_HEADING_ERROR_DEG:-12.0}"
    GAME_PURE_FORWARD_ALIGNMENT_CRAWL="$MATRIX_GAME_PURE_FORWARD_ALIGNMENT_CRAWL"
    export MATRIX_BFM_REALSCAN_WALK_SPEED_MPS="${MATRIX_BFM_REALSCAN_WALK_SPEED_MPS:-$MATRIX_MOON_BFM_SPEED_CAP}"
    export MATRIX_BFM_REALSCAN_JOG_SPEED_MPS="${MATRIX_BFM_REALSCAN_JOG_SPEED_MPS:-${MATRIX_MOON_BFM_JOG_SPEED:-0.60}}"
...
case "${GAME_PURE_FORWARD_ALIGNMENT_CRAWL,,}" in
    1|true|yes|on) GAME_PURE_FORWARD_ALIGNMENT_CRAWL=on ;;
    0|false|no|off) GAME_PURE_FORWARD_ALIGNMENT_CRAWL=off ;;
    *)
        echo "[ERROR] MATRIX_GAME_PURE_FORWARD_ALIGNMENT_CRAWL must be a boolean" >&2
        exit 2
        ;;
esac
...
export MATRIX_GAME_PURE_FORWARD_ALIGNMENT_CRAWL="$GAME_PURE_FORWARD_ALIGNMENT_CRAWL"
